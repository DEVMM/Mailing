...
public class MmBO {
	...
	public void gerarSolicitacao(List<String> estados,List<Integer> idNivel, List<Integer> ckRamoAtividade, List<Integer> idPorte, List<Integer> idArea, List<String> ckSexo ){
